...
create table StudentRegisterCourse(
    ...
    GPA number default null,
    primary key(StudentID,CourseID,Year,Semester)
);
drop table studentregistercourse;
...
-- Existing courses with mapped grades and GPAs
INSERT INTO StudentRegisterCourse (StudentID, CourseID, Year, Semester, Grade, GPA) VALUES (11, 1, 2022, 1, 90, 4.0);
INSERT INTO StudentRegisterCourse (StudentID, CourseID, Year, Semester, Grade, GPA) VALUES (11, 2, 2022, 1, 85, 3.3);
INSERT INTO StudentRegisterCourse (StudentID, CourseID, Year, Semester, Grade, GPA) VALUES (12, 3, 2022, 1, 78, 2.7);
INSERT INTO StudentRegisterCourse (StudentID, CourseID, Year, Semester, Grade, GPA) VALUES (13, 4, 2022, 1, 95, 4.0);
INSERT INTO StudentRegisterCourse (StudentID, CourseID, Year, Semester, Grade, GPA) VALUES (14, 5, 2022, 1, 82, 3.0);

-- Not yet graded (N) for some courses
INSERT INTO StudentRegisterCourse (StudentID, CourseID, Year, Semester, Grade, GPA) VALUES (15, 6, 2022, 1, NULL, NULL);
INSERT INTO StudentRegisterCourse (StudentID, CourseID, Year, Semester, Grade, GPA) VALUES (16, 7, 2022, 1, NULL, NULL);

-- Additional data with mapped grades and GPAs
INSERT INTO StudentRegisterCourse (StudentID, CourseID, Year, Semester, Grade, GPA) VALUES (15, 1, 2022, 1, 88, 3.7);
INSERT INTO StudentRegisterCourse (StudentID, CourseID, Year, Semester, Grade, GPA) VALUES (15, 3, 2022, 1, 75, 2.3);
INSERT INTO StudentRegisterCourse (StudentID, CourseID, Year, Semester, Grade, GPA) VALUES (16, 2, 2022, 2, 92, 3.9);
INSERT INTO StudentRegisterCourse (StudentID, CourseID, Year, Semester, Grade, GPA) VALUES (16, 4, 2022, 2, 68, 1.7);
INSERT INTO StudentRegisterCourse (StudentID, CourseID, Year, Semester, Grade, GPA) VALUES (17, 3, 2022, 1, 87, 3.4);
INSERT INTO StudentRegisterCourse (StudentID, CourseID, Year, Semester, Grade, GPA) VALUES (17, 5, 2022, 1, 94, 3.9);
INSERT INTO StudentRegisterCourse (StudentID, CourseID, Year, Semester, Grade, GPA) VALUES (18, 1, 2022, 2, 79, 2.9);
INSERT INTO StudentRegisterCourse (StudentID, CourseID, Year, Semester, Grade, GPA) VALUES (18, 4, 2022, 2, 85, 3.2);

-- Not yet graded (N) for some courses
INSERT INTO StudentRegisterCourse (StudentID, CourseID, Year, Semester, Grade, GPA) VALUES (19, 6, 2022, 1, NULL, NULL);
INSERT INTO StudentRegisterCourse (StudentID, CourseID, Year, Semester, Grade, GPA) VALUES (19, 7, 2022, 1, NULL, NULL);
INSERT INTO StudentRegisterCourse (StudentID, CourseID, Year, Semester, Grade, GPA) VALUES (20, 5, 2022, 2, NULL, NULL);
INSERT INTO StudentRegisterCourse (StudentID, CourseID, Year, Semester, Grade, GPA) VALUES (20, 2, 2022, 2, NULL, NULL);
...
alter table StudentRegisterCourse
drop column GPA;
...
select * from studentRegisterCourse
join courses using(courseid)
...
begin
    updateStudent(1,'Omar','Ashraf','omar.ashraf@example.com','15-09-2001','M',01289795312,2);
end;
select * from students where studentid=1;

-- calculate gpa for each student
select studentid,calculateStudentLevel(studentid) from students;
...
CREATE OR REPLACE FUNCTION calculateStudentLevel(v_studentID NUMBER)
RETURN NUMBER
IS
    totalHours NUMBER :=0;
    resultLevel NUMBER;
BEGIN
    BEGIN
        SELECT Coalesce(SUM(noofhours),0) 
        INTO totalHours
        FROM studentregistercourse 
        JOIN courses USING(courseid) 
        WHERE studentid = v_studentID AND grade IS NOT NULL and grade >=50;
        
        IF totalHours <= 10 THEN
            resultLevel := 1;
        ELSIF totalHours > 10 AND totalHours <= 20 THEN
            resultLevel := 2;
        ELSIF totalHours > 20 AND totalHours <= 30 THEN
            resultLevel := 3;
        ELSIF totalHours > 30 THEN
            resultLevel := 4;
        END IF;
    EXCEPTION
        WHEN NO_DATA_FOUND THEN
            -- Handle the exception by setting a default value
            resultLevel := 1;
    END;
...
select *
        from studentregistercourse
        join courses using(courseID)
        where studentid =11 and grade is not null;
select studentID ,calculateStudentGPA(studentID)
from students; 
truncate table studentregistercourse;
-- add trigger to prevent inserting same course if he succeded and to check if the course belong to the same department
...
begin
    select departmentID into v_departmentID from students where studentid = :new.studentid;
    
   SELECT COUNT(1)
    INTO v_department_count
    FROM departmentCourses
    WHERE CourseID = :new.courseid AND DepartmentID = v_departmentID;

    IF v_department_count = 0 THEN
        raise_application_error(-20003, 'Course does not belong to the student''s department');
    END IF;
...
show errors
insert into studentregistercourse
values(1,1,2024,1,null);
...
show errors
select courseid,studentid,year,semester,grade,coursename,noofhours ,calculateCourseGrade(grade) as gradeC  from StudentRegisterCourse join courses using(courseID);

select studentid,firstname||' '||lastname as studentName,courseid,coursename,year,semester,grade,calculateCourseGrade(grade) as gradeC from studentRegisterCourse join courses using(courseid) join students using(studentid);
